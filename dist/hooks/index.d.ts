...
export declare function feathersPiniaHooks(): ((context: import("@feathersjs/feathers").HookContext<import("@feathersjs/feathers").Application<any, any>, any>, next: import("@feathersjs/hooks").NextFunction) => Promise<any>)[];
